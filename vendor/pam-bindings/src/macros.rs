    ...
    ($ident:ident) => {
        ...
        mod pam_hooks_scope {
            ...
            pub unsafe extern "C" fn pam_sm_acct_mgmt(
                ...
                unsafe {
                    $crate::macros::invoke_hook(pamh, argc, argv, |pamh, args| {
                        super::$ident::acct_mgmt(pamh, args, flags as PamFlag)
                    })
                }
            }
            ...
            pub unsafe extern "C" fn pam_sm_authenticate(
                ...
                unsafe {
                    $crate::macros::invoke_hook(pamh, argc, argv, |pamh, args| {
                        super::$ident::sm_authenticate(pamh, args, flags as PamFlag)
                    })
                }
            }
            ...
            pub unsafe extern "C" fn pam_sm_chauthtok(
                ...
                unsafe {
                    $crate::macros::invoke_hook(pamh, argc, argv, |pamh, args| {
                        super::$ident::sm_chauthtok(pamh, args, flags as PamFlag)
                    })
                }
            }
            ...
            pub unsafe extern "C" fn pam_sm_close_session(
                ...
                unsafe {
                    $crate::macros::invoke_hook(pamh, argc, argv, |pamh, args| {
                        super::$ident::sm_close_session(pamh, args, flags as PamFlag)
                    })
                }
            }
            ...
            pub unsafe extern "C" fn pam_sm_open_session(
                ...
                unsafe {
                    $crate::macros::invoke_hook(pamh, argc, argv, |pamh, args| {
                        super::$ident::sm_open_session(pamh, args, flags as PamFlag)
                    })
                }
            }
            ...
            pub unsafe extern "C" fn pam_sm_setcred(
                ...
                unsafe {
                    $crate::macros::invoke_hook(pamh, argc, argv, |pamh, args| {
                        super::$ident::sm_setcred(pamh, args, flags as PamFlag)
                    })
                }
            }
        }
